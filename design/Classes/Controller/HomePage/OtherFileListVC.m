...
@interface OtherFileListVC ()<UITableViewDataSource,UITableViewDelegate,MBProgressHUDDelegate,QLPreviewControllerDataSource,QLPreviewControllerDelegate,LoadingFileTVCDelegate>
...
@implementation OtherFileListVC
...
- (void)setupSettings{
    ...
    [footer setTitle:@"暂无更多其他文件" forState:MJRefreshStateNoMoreData];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    LoadingFileTVC *loadingFileTVC = [LoadingFileTVC cellWithTableView:tableView cellidentifier:@"LoadingFileTVCWithOtherFileList"];
...
- (void)checkHistoryFileViewGesture:(UITapGestureRecognizer*)recognizer {
    ...
    conceptSchemeHistoryListVC.viewControllerType = ViewControllerTypeWithOtherFile;
