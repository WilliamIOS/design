...
@interface DesignSketchListVC ()<UITableViewDataSource,UITableViewDelegate,MBProgressHUDDelegate,QLPreviewControllerDataSource,QLPreviewControllerDelegate,LoadingFileTVCDelegate>
...
@implementation DesignSketchListVC
...
- (void)setupSettings{
    ...
    [footer setTitle:@"暂无更多效果图文件" forState:MJRefreshStateNoMoreData];
    [self.loadingFileView setRoundedView:self.loadingFileView cornerRadius:10 borderWidth:4 borderColor:PWColor(202, 64, 99)];
    [self.checkHistoryFileView setRoundedView:self.checkHistoryFileView cornerRadius:10 borderWidth:4 borderColor:PWColor(202, 64, 99)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    LoadingFileTVC *loadingFileTVC = [LoadingFileTVC cellWithTableView:tableView cellidentifier:@"LoadingFileTVCWithDesignSketch"];
...
- (void)checkHistoryFileViewGesture:(UITapGestureRecognizer*)recognizer {
    ...
    conceptSchemeHistoryListVC.viewControllerType = ViewControllerTypeWithDesignSketch;
...
- (void)remindStatusHandle{
    ...
    for (int i = 0; i < [remindDataMutableArray count]; i++) {
        ...
        if ([loadingFileModel.updateName isEqualToString:@"效果图"]) {
