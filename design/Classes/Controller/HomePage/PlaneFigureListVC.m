...
@interface PlaneFigureListVC ()<UITableViewDataSource,UITableViewDelegate,MBProgressHUDDelegate,QLPreviewControllerDataSource,QLPreviewControllerDelegate,LoadingFileTVCDelegate>
...
@implementation PlaneFigureListVC
...
- (void)setupSettings{
    ...
    [footer setTitle:@"暂无更多平面图文件" forState:MJRefreshStateNoMoreData];
    [self.loadingFileView setRoundedView:self.loadingFileView cornerRadius:10 borderWidth:4 borderColor:PWColor(110, 187, 110)];
    [self.checkHistoryFileView setRoundedView:self.checkHistoryFileView cornerRadius:10 borderWidth:4 borderColor:PWColor(110, 187, 110)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    LoadingFileTVC *loadingFileTVC = [LoadingFileTVC cellWithTableView:tableView cellidentifier:@"LoadingFileTVCWithPlaneFigure"];
...
- (void)checkHistoryFileViewGesture:(UITapGestureRecognizer*)recognizer {
    ...
    conceptSchemeHistoryListVC.viewControllerType = ViewControllerTypeWithPlaneFigure;
...
- (void)remindStatusHandle{
    ...
    for (int i = 0; i < [remindDataMutableArray count]; i++) {
        ...
        if ([loadingFileModel.updateName isEqualToString:@"平面图"]) {
